...
insert into TODO (title, description, status, created_at, updated_at, user_id) values ('todo1', 'description1', 'NEW', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 2);
insert into TODO (title, description, status, created_at, updated_at, user_id) values ('todo2', 'description2', 'DONE', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 2);
insert into TODO (title, description, status, created_at, updated_at, user_id) values ('todo3', 'description3', 'NEW', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 2);
insert into TODO (title, description, status, created_at, updated_at, user_id) values ('todo4', 'description4', 'DONE', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 1);
